...
Readonly my $IPV6_RE => qr/^([0-9A-Fa-f]{1,4}:[0-9A-Fa-f:]{1,}(:[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3})?)\$|([0-9A-Fa-f]{1,4}::[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3})\$/;

Readonly my $API_KEY_RE             => qr/^[a-zA-Z0-9-_]{1,512}$/;
Readonly my $CLIENT_ID_RE           => qr/^[a-zA-Z0-9-+~_.: ]{1,50}$/;
Readonly my $CLIENT_VERSION_RE      => qr/^[a-zA-Z0-9-+~_.: ]{1,50}$/;
Readonly my $DIGEST_RE              => qr/^[A-Fa-f0-9]{40}\$|^[A-Fa-f0-9]{64}\$/;
Readonly my $IPADDR_RE              => qr/^$|$IPV4_RE|$IPV6_RE/;
Readonly my $JSONRPC_METHOD_RE      => qr/^[a-zA-Z0-9_-]*$/;
Readonly my $LANGUAGE_RE            => qr/^[a-z]{2}(_[A-Z]{2})?$/;
Readonly my $PROFILE_NAME_RE        => qr/^[a-zA-Z0-9]$|^[a-zA-Z0-9][a-zA-Z0-9_-]{0,30}[a-zA-Z0-9]$/;
Readonly my $RELAXED_DOMAIN_NAME_RE => qr/^[.]$|^.{2,254}$/;
Readonly my $TEST_ID_RE             => qr/^[0-9a-f]{16}$/;
Readonly my $USERNAME_RE            => qr/^[a-zA-Z0-9-.@]{1,50}$/;
