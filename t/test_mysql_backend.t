...
threads->create( sub { Zonemaster::WebBackend::Runner->new({ db => 'Zonemaster::WebBackend::DB::MySQL'} )->run(1); } )->detach();
...
require_ok('Zonemaster::WebBackend::Runner');
threads->create( sub { Zonemaster::WebBackend::Runner->new({ db => 'Zonemaster::WebBackend::DB::MySQL'} )->run(2); } )->detach();
...
require_ok('Zonemaster::WebBackend::Runner');
threads->create( sub { Zonemaster::WebBackend::Runner->new({ db => 'Zonemaster::WebBackend::DB::MySQL'} )->run(3); } )->detach();
